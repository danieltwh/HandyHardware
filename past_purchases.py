...
class Request_Page(Frame):
    ...
    def __init__(self,curr_paymentId, master):
        ...
        title = Label(self, text="Request Page", font=('Helvetica 20 bold'))
        ...
        colour_label = Label(self, text="Colour: ", font=('Helvetica 12 bold'))
        colour_label.grid(row=3, column=0)
        colour = Label(self, text=curr_colour)
        colour.grid(row=3, column=1, padx=20)

        power_label = Label(self, text="Power Supply: ",font=('Helvetica 12 bold'))
        ...
        warranty_label = Label(self, text="Warranty: ", font=('Helvetica 12 bold'))
        ...
        issue_label = Label(self, text="What is the issue of the item?", font=('Helvetica 12 bold'))
        ...
        return_btn = Button(self, text="Return to Past Purchases Page", command= lambda: self.returnRequest())
...
class Request_Details(Frame):
    def __init__(self, curr_itemId, master):
        ...
        if int(curr_amount) == 0:
            ...
            amount.grid(row=6, column=1, padx=20)
        else:
            amount_label = Label(self, text="Payment Amount: ", font=('Helvetica 12 bold'))
            amount_label.grid(row=6, column=0)
        ...
        if curr_requestStatus in ['Submitted', 'Submitted and Waiting for payment']:
            ...
            cancel_btn.grid(row=9, column=1
            ...
            if int(curr_amount) > 0:
                ...
                pay_btn.grid(row=9, column=2, pady = 15)
...
class Cancel_Request_Page(Frame):
    def __init__(self, master):
        ...
        title = Label(self, text="Request has been cancelled.",font=('Helvetica 20 bold'))
        ...
        submit_btn.grid(row=11, column=400, columnspan=2, pady=15)
...
class Pay_Request_Page(Frame):
    def __init__(self, master):
        ...
        title = Label(self, text="Request has been paid. We will be proceeding your request",font=('Helvetica 20 bold'))
        title.grid(row=0, column=400, pady =60)
