...
class Catalogue_Table(tk.LabelFrame):
    def __init__(self, data, *args, **kwargs):
        ...
        tk.Label(self, text="Number of Items Sold", anchor="w").grid(row=0, column=5, sticky="ew", padx=10)
        tk.Label(self, text="Number of Items Available", anchor="w").grid(row=0, column=6, sticky="ew", padx=10)
        items = mydb.items
...
class Admin_Shopping_Catalogue_Page_Header(tk.LabelFrame):
    def __init__(self, master, *args, **kwargs):
        ...
        title = tk.Label(self, text="Item Catalogue Page", font=tkFont.Font(size=20), width = 20)
